...
## Purpose
Document the Gears system's 4-gear workflow for operators and agents.

## Principles
- **Shared design system** — Same CSS variables, layout, and navigation pattern across all four gear sites for brand consistency.
...
## Success Criteria
- ✅ All 4 gear sites deployed and accessible at their `*.gears.run` subdomains.
